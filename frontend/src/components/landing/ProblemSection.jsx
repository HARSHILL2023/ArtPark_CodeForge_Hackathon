      ...
      <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
        {[
          ...
          <motion.div
            key={i}
            variants={item}
            className="p-5 rounded-xl bg-[#FCFBF8] dark:bg-[#121416] border border-[#DCD9D1] dark:border-[#292D33] text-left space-y-2.5 hover-card hover-glow-blue cursor-default"
          >
            <div className="text-3xl sm:text-4xl font-bold text-[#2563EB] dark:text-[#3B82F6] font-mono transition-transform duration-200 hover:scale-105 inline-block">
              {stat.v}
            </div>
